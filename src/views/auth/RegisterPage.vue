    ...
    <div class="auth-split">
      ...
      <div class="auth-left">
        <div class="auth-left__content">
          ...
          <h1 class="auth-left__title">Join the team</h1>
          <p class="auth-left__desc">Create your SportFlex account to unlock exclusive deals, track orders, and build your wishlist.</p>
          <div class="auth-left__features">
            <div class="auth-feature">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>
              <span>Exclusive athlete discounts</span>
            </div>
            <div class="auth-feature">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>
            ...
            <div class="auth-feature">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>
              <span>Personalized gear recommendations</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="auth-right">
        <div class="auth-card animate-fade-in">
          ...
          <p class="auth-sub">Fill in your details to join the team</p>
